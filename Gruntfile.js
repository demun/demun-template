  ...
  grunt.initConfig({
    ...
    less: {
        docs: {
            ...
            src: '<%= config.app %>/styles/style.less',
            dest: '<%= config.app %>/styles/style.css'
        },
    },
    ...
    //   generated: {
    //     files: [
    //       { // 사이트에 사용되는 js 를 하나로 합친다.
    //         src: [
    //           'app/scripts/controllers/thing-controller.js',
    //           'app/scripts/models/thing-model.js',
    //           'app/scripts/views/thing-view.js'
    //         ],
    //         dest: '.tmp/concat/scripts/customjs.js'
    //       }
    //     ]
    //   }
    // },
    ...
    //     files: [
    //       {
    //         src: [ '.tmp/concat/scripts/customjs.js' ],
    //         dest: 'dist/scripts/customjs.js'
    //       }
    //     ]
    //   }
    // },
